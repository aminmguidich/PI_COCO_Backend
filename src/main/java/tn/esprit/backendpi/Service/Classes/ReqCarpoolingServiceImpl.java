...
public class ReqCarpoolingServiceImpl implements IReqCarpoolingService {
    ...
    private static String htmlTemplate (String productName,String receiverName,String senderName){
        return ("<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n" +
                ...
                "  </head>\n" +
                "  <body>\n" +
                "    <span class=\"preheader\">//TODO:badel he4i</span>\n" +
                ...
                "                                <tr>\n" +
                "                                  <td align=\"left\">\n" +
                "                                    <a href=\"{{action_url}}\" class=\"f-fallback button\" target=\"_blank\">Accept</a>\n" +
                "                                  </td> " +
                "                                   <td align=\"right\">\n" +
                "                                       <a href=\"{{action_url}}\" class=\"f-fallback button\" target=\"_blank\">Decline</a>\n"+
                "                                   </td>\n"+
                "                                </tr>\n" +
                "                              </table>\n" +
                "                            </td>\n" +
    ...
    private User loggedInUser=new User(1L,"Hssan",null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null,null);
    @Override
    public RequirementCarpooling addReqCarpooling(RequirementCarpooling requirementCarpooling) {
        ...
        try {
            emailService.sendSimpleMessage(requiredUser.getEmail(),"Requirement", htmlTemplate("Coco",requiredUser.getName(),loggedInUser.getName()));
